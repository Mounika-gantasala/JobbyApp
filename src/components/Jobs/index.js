...
class Jobs extends Component {
  ...
  getJobs = async () => {
    ...
    const {employeeTypeList, minimumSalary} = this.state
    // console.log(employeeTypeList)
    // employeeTypeList is empty on initial page load when any input of type of employment is clicked
    // we are setting state of this type in changeEmployeeList function
    const apiUrl = `https://apis.ccbp.in/jobs?employment_type=${employeeTypeList.join()}&minimum_package=${minimumSalary}`
